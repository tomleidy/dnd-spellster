...
def is_level_school_etc(line: str) -> bool:
    ...
    return re.match(regex_dict["level_school"], line, flags=RE_FLAGS) or re.match(
        regex_dict["school_cantrip"], line, flags=RE_FLAGS
    )
...
def is_at_higher_levels(line: str) -> bool:
    """Does this line contain information about the spell at higher levels?"""
    return re.match(regex_dict["at_higher_levels"], line, flags=RE_FLAGS)
